...
private let ratesURL = "https://aurora-price-tickers.herokuapp.com/rates" 
private let fallbackRatesURL = "https://aurora-price-tickers.herokuapp.com/rates"
        ...
        let task = dataTaskWithRequest(request) { (data, response, error) in
            ...
            if let data = dataRAW,
               ...
               // let jsonDataDictionary = jsonData as? [String: Any]
                //let parsedData = jsonDataDictionary!["tickers"]
