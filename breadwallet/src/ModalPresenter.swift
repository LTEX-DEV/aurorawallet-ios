...
class ModalPresenter : Subscriber, Trackable {
    ...
    private func makeSettings() {
        ...
        let sections = ["Wallet", "Manage", "Auroracoin", "Advanced"]
        var rows = [
            "Wallet": [/*Setting(title: S.Settings.importTile, callback: { [weak self] in
                ...
                // TODO: Writeup support/FAQ documentation for auroracoin wallet
            ...
            "Advanced": [
                Setting(title: "Advanced", callback: { [weak self] in
                    ...
                    let advancedSettings = [
                        "Network": [
                            Setting(title: "Auroracoin Nodes", callback: {
        ...
        /*rows["Auroracoin"]?.append( Setting(title: S.Settings.review, callback: {
