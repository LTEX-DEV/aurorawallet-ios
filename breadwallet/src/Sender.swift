...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/auroracoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/auroracoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/auroracoin-paymentack" && data.count <= 50000 {
