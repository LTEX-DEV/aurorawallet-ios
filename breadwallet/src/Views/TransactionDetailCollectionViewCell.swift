...
class TransactionDetailCollectionViewCell : UICollectionViewCell {
    ...
    func set(transaction: Transaction, isBtcSwapped: Bool, rate: Rate, rates: [Rate], maxDigits: Int) {
        ...
        amountAUR.text = transaction.amountDescription(isBtcSwapped: false, rate: rate, maxDigits: maxDigits)
    ...
    private let amountAUR = UILabel(font: .customMedium(size: 18.0), color: C.Colors.text)
    ...
    private let card: UIView = {
        let c = UIView()
        // #2E3046
        c.backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1.0) //2E 30 46 //00886f
    ...
    private func addConstraints() {
        ...
        amountAUR.constrain([
            amountAUR.centerYAnchor.constraint(equalTo: digiLogo.centerYAnchor, constant: 0),
            amountAUR.leftAnchor.constraint(equalTo: digiLogo.rightAnchor, constant: 10),
            amountAUR.heightAnchor.constraint(equalToConstant: 31),
        ])
        ...
        timeSinceTransactionLabel.constrain([
            ...
            timeSinceTransactionLabel.leftAnchor.constraint(equalTo: amountAUR.rightAnchor, constant: 10),
    ...
    private func setData() {
        ...
        amountAUR.lineBreakMode = .byCharWrapping
