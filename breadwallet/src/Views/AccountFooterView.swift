...
fileprivate class RadialGradientMenu: UIView {
    ...
    private func configure() {
        ...
        circleView.backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1.0) //UIColor(red: 0x02 / 255, green: 0x52 / 255, blue: 0xAA / 255, alpha: 1)
...
fileprivate class FooterBackgroundView: UIView {
    override init(frame: CGRect) {
        ...
        backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1.0) //UIColor(red: 0x0F / 255, green: 0x0F / 255, blue: 0x1A / 255, alpha: 1)
    }
...
//    var showAddressCallback: (() -> Void)?
    ...
    private let startColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6F / 255, alpha: 1.0) //UIColor(red: 0x02 / 255, green: 0x5C / 255, blue: 0xBA / 255, alpha: 1)
    private let endColor = UIColor(red: 0x01 / 255, green: 0x4C / 255, blue: 0x3E / 255, alpha: 1.0)
    //UIColor(red: 0x01 / 255, green: 0x36 / 255, blue: 0x74 / 255, alpha: 1)
    ...
    func setupSubViews(){
       ...
       // digiIDButton.contentMode = .scaleAspectFit
        ...
        circleButtonContainer.backgroundColor = UIColor(red: 0x01 / 255, green: 0x4C / 255, blue: 0x3E / 255, alpha: 1.0) //UIColor(red: 0x0F / 255, green: 0x0F / 255, blue: 0x1A / 255, alpha: 1)
       ...
       // remove backgroundView.addSubview(digiIDButton)
        backgroundView.addSubview(blurView)
        backgroundView.addSubview(circleButtonContainer)
        
        // add constraints //removing it
