...
fileprivate class AddressBookAddContactViewController: UIViewController {
    ...
    init(style: Style = .add) {
        ...
        topBox.backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1.0) // 36 37 55 //0x00886f
...
fileprivate class AddressBookSearchBar: UITextField {
    init() {
        ...
        backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1.0) // 36 37 55 //00886f
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.callback = { [weak self] newContactData in
            ...
            if let me = self {
                ...
                if let toUpdate = me.contacts.index(where: { (contact) -> Bool in
