...
fileprivate class WelcomeViewStartPage: UIViewController {
    ...
    fileprivate let descLabel: UILabel = {
        let lbl = UILabel(font: .customBody(size: 16), color: UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1)) //156 158 185 //00886f
...
fileprivate class WelcomeViewPage: UIViewController {
    ...
    fileprivate let subTitleLabel = UILabel(font: .customBody(size: 18), color: UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1)) //156 158 185  //00886f
...
class WelcomeViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private let first = WelcomeViewStartPage(smallImage: #imageLiteral(resourceName: "welcome_midniteIcon"), title: "Welcome to the Auroracoin wallet.", description: "Safely store and use your Auroracoin currency.")
    private let second = WelcomeViewPage(image: #imageLiteral(resourceName: "welcome_send"), title: "Send", description: "Effortlessly and instantly send your Auroracoin globally.")
    ...
    private let fourth: WelcomeViewPage = {
        ...
        let p = WelcomeViewPage(
            ...
            title: "Safely store",
            description: "Protect your Auroracoin with a range of advanced security features.",
            topView: view
        )
