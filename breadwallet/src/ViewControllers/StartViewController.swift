...
class StartViewController : UIViewController {
    ...
    private let create: UIButton = {
        ...
        gradient.colors = [
            UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1).cgColor, // 0066cc //00886f
            UIColor(red: 0x01 / 255, green: 0x69 / 255, blue: 0x59 / 255, alpha: 1).cgColor, // 002352 //016959
        ]
    ...
    private func addSubviews() {
        ...
        faq.isHidden = true // TODO: Writeup support/FAQ documentation for auroracoin wallet
