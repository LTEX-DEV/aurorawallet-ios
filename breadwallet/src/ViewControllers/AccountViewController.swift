...
fileprivate class BalanceView: UIView, Subscriber {
    ...
    private func addStyles() {
        ...
        balanceHeaderLabel.textColor = .white
...
//        ])
        ...
        backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1.0) //232437  //00886f
...
fileprivate class HamburgerViewMenu: UIView {
    ...
    private var auroracoinLogo = UIImageView(image: #imageLiteral(resourceName: "DigiByteSymbol"))
    private let walletLabel = UILabel(font: .customMedium(size: 18), color: C.Colors.text)
    private let walletVersionLabel = UILabel(font: .customMedium(size: 11), color: .white)
    ...
    func animationStep(progress: CGFloat) {
        ...
        if progress < 0.3 {
            auroracoinLogo.transform = CGAffineTransform.init(scaleX: 0.3, y: 0.3)
        } else {
            auroracoinLogo.transform = CGAffineTransform.init(scaleX: progress, y: progress)
        }
    }
    ...
    private func addConstraints() {
        ...
        auroracoinLogo.constrain([
            auroracoinLogo.topAnchor.constraint(equalTo: self.topAnchor, constant: 78),
            auroracoinLogo.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: 10),
            auroracoinLogo.widthAnchor.constraint(equalToConstant: 90),
            auroracoinLogo.heightAnchor.constraint(equalToConstant: 90),
        ])
        
        walletLabel.constrain([
            walletLabel.topAnchor.constraint(equalTo: auroracoinLogo.bottomAnchor, constant: 16),
            walletLabel.centerXAnchor.constraint(equalTo: auroracoinLogo.centerXAnchor),
        ...
        walletVersionLabel.constrain([
            ...
            walletVersionLabel.centerXAnchor.constraint(equalTo: auroracoinLogo.centerXAnchor),
...
class AccountViewController: UIViewController, Subscriber, UIPageViewControllerDataSource, UIPageViewControllerDelegate, HamburgerViewMenuProtocol, UIScrollViewDelegate {
   ...
   /*removed var digiIDCallback: (() -> Void)? {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1) //191b2a //00886f
