...
class SyncViewController: UIViewController, Subscriber {
    ...
    private let syncPercentageSignLabel = UILabel(font: .customBold(size: 35), color: UIColor.white)
    
    private let blockHeightCaptionLabel = UILabel(font: .customBody(size: 13), color: UIColor.white)
    private let blockHeightLabel = UILabel(font: .customBody(size: 36), color: UIColor.white)
    private let progressCaptionLabel = UILabel(font: .customBody(size: 13), color: UIColor.white)
    private let progressLabel = UILabel(font: .customBody(size: 32), color: UIColor.white) // attributed text of syncdate / currentdate
    
    private let animatedWaveView = DGBAnimatedWaveView(color: UIColor(red: 0x01 / 255, green: 0x4C / 255, blue: 0x3E / 255, alpha: 1.000), background: UIColor(red: 0x00 / 255, green: 0x88 / 255, blue: 0x6f / 255, alpha: 1)) // #191b2a //00886f
