...
class AboutViewController : UIViewController {
    ...
    private func setData() {
        ...
        introductionLabel.text = "This app was built by Auroracoin & Blockchain enthusiasts, unpaid volunteers who devoted their time and skills to a project they believe in."
